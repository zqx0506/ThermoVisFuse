...
class test_dataset:
    ...
    def load_data(self):
        ...
        depth = cv2.imread('/home/magus/hrc_workspace/SwinMCNet/SwinMCNet/dataset/VT1000/Test/T/'+name)
        depth = cv2.cvtColor(depth, cv2.COLOR_BGR2RGB)
        image = cv2.imread('/home/magus/hrc_workspace/SwinMCNet/SwinMCNet/dataset/VT1000/Test/RGB/' + name)
        ...
        return image, gt, depth, name, np.array(image_for_post), self.index
